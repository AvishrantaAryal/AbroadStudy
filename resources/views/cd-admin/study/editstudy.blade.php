...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Edit Study Destination</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Study Destination </h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
        ...
        <div class="form-group">
                <label for="Why" class="col-sm-2 control-label">Why There?<span style="color: red;">*</span></label>
                <div class="text text-danger">{{$errors->first('why')}}</div>

                <div class="col-sm-10">
                 <textarea class="form-control" name="why" required="" >
                  {!!$t['why']!!}
                </textarea>
              </div>
            </div>
            ...
            <div class="form-group">
                <label for="Education System" class="col-sm-2 control-label">Education System<span style="color: red;">*</span></label>
                <div class="text text-danger">{{$errors->first('education')}}</div>

                <div class="col-sm-10">
                 <textarea class="form-control" name="education" required="" >
                  {!!$t['education']!!}
                </textarea>
              </div>
            </div>
            ...
            <div class="form-group">
                <label for="Cost " class="col-sm-2 control-label">Cost & <br>Scholorship<span style="color: red;">*</span></label>
                <div class="text text-danger">{{$errors->first('cost')}}</div>

                <div class="col-sm-10">
                 <textarea class="form-control" name="cost" required="" >
                  {!!$t['cost']!!}
                </textarea>
              </div>
            </div>
